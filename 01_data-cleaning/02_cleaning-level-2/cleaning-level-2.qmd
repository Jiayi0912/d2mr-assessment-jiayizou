...
<!-- answer below -->
- Replacing data in "Population Density" with "Population per Sq Mile" is better than preserving the original data, since the latter uses consistent calculation unit and reduces misunderstanding.
