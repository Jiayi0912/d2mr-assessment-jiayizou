...
<!-- answer below -->
- Deleting duplicate column and adding the missing columns
- Rename columns
- Reorder columns
- Change data types: except for County and State columns, change Category column to factor, and other columns to numeric
...
<!-- answer below -->
- Change column names into a form that can seperate poppulation/percentage with the variable type (e.g. change "Population Density" to "Pop.Density" rather than "popdensity" in the original dataset). In this case it's more explicit for researchers to run data analysis and to avoid confusion between "pop" and "perc".
